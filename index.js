...
var content =
[
  {question: 'How many months have 28 days?', choices: [1, 6, 8, 12], correct: 0},
  {question: 'What is the missing number: 4, 8, 14, 22, ?', choices: [26, 28, 32, 36], correct: 2},
  {question: 'There are 12 pens on the table, you took 3, how many do you have?', choices: [3, 12, 9, 15], correct: 2},
...
function choices() {
  if (content[x] === undefined) {
    ...
    //  document.answer.style.visibility = 'hidden';
    document.querySelector('.quiz').style.visibility = 'hidden';
    document.querySelector('.answer').style.visibility = 'hidden';
    // document.querySelectorAll('.buttonSubmit').style.visibility = 'hidden';
    document.querySelector('.question').style.visibility = 'hidden';

  } else {
    var questionNumber = document.querySelector('.questionNumber');
    questionNumber.textContent = 'Question ' + y + ' of 5';
